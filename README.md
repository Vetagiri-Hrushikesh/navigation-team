...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/oTZDOtVDtB)
...
```sh
npx nx serve navigation-team
```

To create a production bundle:

```sh
npx nx build navigation-team
```

To see all available targets to run for a project, run:

```sh
npx nx show project navigation-team
```
